...
- `ths2017/two_mode/car_taz.csv`, `ths2017/two_mode/transit_taz.csv` — survey-only two-mode matrices (778×778), transit with the RavKav × OnBoard-calibrated bus layer (see [METHODOLOGY.md §6m](METHODOLOGY.md#6m-step-15--two-mode-matrix-from-the-trips-file-transit-calibrated-to-ravkav--onboard-ths_2017_two_mode_matrixipynb)); calibration tables and mode shares alongside
